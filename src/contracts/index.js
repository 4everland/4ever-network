...
var Contracts = /** @class */ (function () {
    function Contracts() {
        this.contractAddress = "0x6B39778aAde00b3a99e463934b614Aa41dFAF09b";
    }
    ...
    Contracts.prototype.sendTransaction = function (tx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        from = _a.sent();
                        return [2 /*return*/, this.signer.sendTransaction(__assign({ from: from }, tx))];
                }
            });
        });
    };
    ...
    Object.defineProperty(Contracts.prototype, "POSC", {
        get: function () {
            return types_1.POSC__factory.connect(this.contractAddress, this.provider);
        },
        enumerable: false,
        configurable: true
    });
