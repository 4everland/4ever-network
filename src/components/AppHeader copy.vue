<template>
  <div>
    <v-app-bar fixed app color="#FAFAFA" height="50">
      <v-container class="d-flex align-center justify-space-between">
            ...
            >
              ...
              <div v-if="isShow && status" class="content">
                ...
                >
                  <span
                    class="block-info"
                    @click="handleViewClick(searchData.block, 'reportDetail')"
                ...
                >
                  <span
                    class="block-info"
                    @click="handleViewClick(searchData.node, 'nodeDetail')"
                    >{{ searchData.node.nodeId }}</span
                  >
                  <span class="block-time">
                    {{ formart_date(searchData.node.createdAt) }}
                  </span>
                </div>
                <div
        ...
        <v-dialog class="rounded-xl" v-model="claimDialog" width="500">
          <v-card class="pl-7 pr-7 pb-11 rounded-xl">
            <v-card-title class="dialog-title pa-0 justify-center mt-8">
              My Reward
              <img
                class="dialog-close"
            ...
            <v-card-text class="text-center mt-10 pb-14">
              <span class="claim-balance">{{ $store.state.balance }}</span>
